    ...
    return(
        <>
            <div className="signin-content">
                ...
                <EmailPasswordLogin />
                <h3>--------　新規会員登録　--------</h3>
                <p className="discription">投稿にはGoogle認証か会員登録が必要となります。</p>
                <SignInWithGoogle />
                <p>--------------------　OR　--------------------</p>
...
function SignInWithGoogle () {
    ...
    return(
        <div className="google-signin-method">
            <img src="image/btn_google_normal.png" className="google-button" alt="Google-signin" />
            <img src="image/btn_google_normal_pressed.png"
            alt=""
