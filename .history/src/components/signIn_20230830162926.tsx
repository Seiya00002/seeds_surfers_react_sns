...
function SignInWithEmailPassword() {
    ...
    const DEFAULT_PROFILE_IMAGE_URL = "https://firebasestorage.googleapis.com/v0/b/seeds-surfers-react-sns.appspot.com/o/profile_images%2Fcacutus-icon.png?alt=media";
